            ...
            <div className="bg-page-bg h-screen flex items-center justify-center">
                <FadeIn>
                    <div className="text-center flex flex-col gap-4">
                        ...
                        <Link href="/overview" className="inline-block bg-cyan-bright text-white px-6 py-2 rounded-full hover:bg-white hover:text-cyan-950 hover:scale-105 transition-all duration-300">
                                Back to Overview
                        </Link>
                    </div>
                </FadeIn>
